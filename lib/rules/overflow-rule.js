    ...
    for (const element of elements) {
      ...
      if (rightEdge > viewportWidth) {
        ...
        if (computedStyle.display === 'flex' || computedStyle.display === 'inline-flex') {
          ...
          // clientWidth includes padding; the box-model content width does not,
          // so comparing against rect.width would flag any padded container.
          const clientWidth = context.getClientWidth
            ? await context.getClientWidth(element)
            : rect.width;
